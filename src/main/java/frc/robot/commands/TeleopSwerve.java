...
public class TeleopSwerve extends Command {    
    ...
    public TeleopSwerve(SwerveDrive s_swerveDrive, DoubleSupplier translationSup, DoubleSupplier strafeSup, DoubleSupplier rotationSup, BooleanSupplier robotCentricSup) {
        this.s_swerveDrive = s_swerveDrive;
        addRequirements(s_swerveDrive);
